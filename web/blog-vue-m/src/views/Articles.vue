...
<script>
    ...
    export default {
        ...
        mounted(){
            this.fetchArticle()
            this.article_upvote = JSON.parse(localStorage.getItem("article_upvote"))[this.$route.params.id]
        },
        created() {
            this.getComment()
        },
